<template>
	<div>
		...
		<div  id="downDiv" style="overflow: auto; position: relative;">
			<ul class="ul-layout" id="ul-layout" style="">
				<div v-for="item in pointsHistroy" id="showBodyData">
			...
			<div class="currentActivity" style="text-align: center;" v-if="netError">
				<div>
					<img src="../assets/img/404.png" style="margin-top: 20%;"></img>
					<br/>
			...
			getData() {
				...
				ajaxRequest({
					...
					success: function(dataJson) {
						...
						if(!dataJson.result.expendPoints) {
							//document.getElementById('demo-infinite-container').innerHTML="<span id='emptyHistroyData'>暂无信息</span>";
							self.netError = true;
						} else {
...
//			alert(height)
			...
			//		alert(document.getElementById("asdfasdfasdf"));
