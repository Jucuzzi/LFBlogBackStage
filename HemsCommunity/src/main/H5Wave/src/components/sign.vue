<template>
	<div class="sign-root">
		...
		<div class="upper-div-outer">
			<div class="upper-div">
				...
				<div class="upper-below-div">
					<div class="sign-btn">
						<span class="sign-day-num" id="sign-day-num" v-on:click="showCalendarDialog">连续签到0天</span>
					</div>
		...
		<div class="lower-div" id="lower-div">
		...
		<div class="currentActivity" style="text-align: center;" v-if="netError">
			<div>
				...
				<br/>
				<label style="color: lightgray; font-weight: 300; margin-bottom: 10px;">当前网络较差，暂无数据</label>
			</div>
		</div>
			...
			<div class="modal-dialog modal-content">
				<div class="modal-body">
					<div class="colse1" data-dismiss="modal">
						<img class="colse1" src="../assets/images/closeIcon.png"/>
					</div>
					<div class="wrap">
						...
						<div class="foot">
							<div class="rule-bottom">
								<span class="rule-bottom-font-left">今日打卡排在第</span>
								<span class="rule-bottom-font-orange" id="rule-bottom-font-orange">0</span>
								<span class="rule-bottom-font">位</span>
							</div>
							<div class="rule-child-item-right">
								<span class="get-points" id="new-points">+0 积分</span>
							</div>
						</div>
						<div class="rule-bottom">
							<span class="rule-bottom-font-left">已连续签到</span>
							<span class="rule-bottom-font-orange" id="rule-bottom-font-Current">0</span>
							<span class="rule-bottom-font">天</span>
						</div>
					</div>
				</div>
			</div>
...
//						alert(JSON.stringify(dataJson.result.signInList.signList));
						for (var index=0;index<dataJson.result.signInList.length;index++){
							var showTime = dataJson.result.signInList[index].signInTime;
							 dataJson.result.signInList[index].signInTime = 
						showTime.substring(8,10)+":"+
						showTime.substring(10,12)+":"+
						showTime.substring(12,14);
						}
//						alert(JSON.stringify(dataJson.result.signInList));
