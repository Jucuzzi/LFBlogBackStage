	...
	<body topmargin="0" leftmargin="0" rightmargin="0">
		...
		<div style="height: 300px;width: 100%;position: absolute;">
			...
			<div class="titleImg" style="text-align: center;">
				<img :src="this.topUser.userIconPath" id="theOne" />
			</div>
		...
		<div class="list-wrapper list-wrapper-hook" id="downDiv">
			...
			<div>
				<!-- 列表 -->
				<ul class="list-infoView" v-if="!netError">
					<li class="tableView-cell-noBorder">
						<div class="userInfo">
							...
							<div class="selfTitleImage">
								<img :src="userIconPath" id="theShow" />
							</div>
							<div class="selfName">
								{{userName}}
							</div>
...
<script>
	export default {
		...
		mounted() {
			this.getData();
			//设置自适应高度
			var height = window.screen.height - 300-20;
			$("#downDiv").css("height", height); //通过设置CSS属性来设置元素的高
				...
				ajaxRequest({
					...
					success: function(dataJson) {
						...
						if(self.userIconPath == "") {
							self.netError = true;
							$(".backgroundView").css("background", 'url(../../static/img/defaultBackground.png)');
							$(".backgroundView").css("background-size", '100% 125%');
