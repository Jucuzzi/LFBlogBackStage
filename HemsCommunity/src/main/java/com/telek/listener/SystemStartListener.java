...
public class SystemStartListener extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		String index = this.getServletContext().getRealPath("/");
		System.out.println(index);
		String projectIndex = index.substring(0, index.length()-2);
		ConstantVar.IMG_PATH = projectIndex.substring(0, projectIndex.lastIndexOf("\\")) +ConstantVar.IMG_ROOT_PATH;
