...
public class Util {
	...
	public static UserEntity getCurrentUser(HttpServletRequest request) {
		...
		if (user == null || user.getUserId() == null) {
			...
			user = new UserEntity();
			user.setId("8a8a8bd25e79d6bd015e79de003a0008");
			user.setName("hems2910");
			user.setUserId("2910");
			user.setNickName("智障惠12测试");
			user.setUserIconPath("UserPic/20170908/581a9ec16ae047b7bfe0df3bebafb131.png");
			user.setUserType("2");
		}
		return user;
	}
