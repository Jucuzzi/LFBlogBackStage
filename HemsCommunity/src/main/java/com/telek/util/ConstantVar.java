...
public class ConstantVar {
	...
	/**
	 * 图片分类:0-普通图片；1-用户相关；2-资讯相关；3-积分商城相关；4-签到相关
	 */
	public static final String IMG_ROOT_PATH = "/InformationImage_test/";
//	public static final String IMG_PATH = "/Users/Jucuzzi/HemsCommunityImage/"+IMG_ROOT_PATH;
	
	public static  String IMG_PATH = "";
//	public static final String IMG_PATH = "D:/"+IMG_ROOT_PATH;
	public static final int IMG_TYPE_ZERO = 0;
	public static final String IMG_PATH_TYPE_ZERO = "GeneralPic";
	
	public static final int IMG_TYPE_ONE = 1;
	public static final String IMG_PATH_TYPE_ONE = "UserPic";
	
	public static final int IMG_TYPE_TWO = 2;
	public static final String IMG_PATH_TYPE_TWO = "InformationPic";
	
	public static final int IMG_TYPE_THREE = 3;
	public static final String IMG_PATH_TYPE_THREE = "IntegralPic";
	
	public static final int IMG_TYPE_FOUR = 4;
	public static final String IMG_PATH_TYPE_FOUR = "SignPic";
	/**
	 * 举报类型：10101-资讯，10102-评论
	 */
	public static final String REPORT_TYPE_ONE = "10101";
	public static final String REPORT_TYPE_TWO = "10102";
	
	public static String PROJECT_INDEX = "";
